...
public class WenXueFragment extends Fragment {
    ...
    public static WenXueFragment newInstance(Context c) {
        context = c;
        return new WenXueFragment();
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (isVisibleToUser && isFirst) {
            ...
            myAsyncTask.execute(ApiList.SearchBookUrl + ApiList.BookSearchTags[0]);
